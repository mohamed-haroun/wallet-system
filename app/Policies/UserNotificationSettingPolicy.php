...
class UserNotificationSettingPolicy
{
     ...
     */
    public function restore(User $user, UserNotificationSetting $userNotificationSetting): bool
    {
        return false;
    }
     ...
     */
    public function forceDelete(User $user, UserNotificationSetting $userNotificationSetting): bool
    {
        return false;
    }
}
